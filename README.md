...
| POST   |/friendstatus/:friendId/revoke| const friendId = req.params.friendId, current userId               | json(response.data)                    | Will remove the current user ID from the other users' confirmed friends and vice versa.|
